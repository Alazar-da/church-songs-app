    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary-50 to-white">
        <div className="text-center px-4">
          ...
          <p className="text-primary-700 font-medium">Loading subcategory...</p>
        </div>
      </div>
    )
  }
              ...
              {!existingImageUrl && !newImage && (
                <div className="mt-3 flex items-start gap-2 p-3 bg-blue-50 rounded-lg">
                  ...
                  <p className="text-xs text-blue-700">
                    No image uploaded. Upload an image to make your subcategory more attractive.
                  </p>
                </div>
              )}
            </div>
              ...
              >
                {loading ? (
                  <>
                    ...
                    <span>Updating Subcategory...</span>
                  </>
                ) : (
                  <>
